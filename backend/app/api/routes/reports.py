...
def export_excel(forecast_id: int, db: Session = Depends(get_db),
    ...
    ws = wb.active
    ws.title = "Summary"
    orange_fill = PatternFill(start_color="166534", end_color="166534", fill_type="solid")
...
def export_pdf(forecast_id: int, db: Session = Depends(get_db),
    ...
    elements = []
    title_style = ParagraphStyle("title", parent=styles["Title"], textColor=orange, fontSize=18)
    ...
    table.setStyle(TableStyle([
        ("BACKGROUND", (0,0), (0,-1), light_orange), ("TEXTCOLOR", (0,0), (0,-1), orange),
