...
const priorityColors = { high:"border-l-4 border-red-400 bg-red-50 dark:bg-red-900/20", medium:"border-l-4 border-yellow-400 bg-yellow-50 dark:bg-yellow-900/20", low:"border-l-4 border-orange-400 bg-primary-50 dark:bg-primary-900/40" };
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={label} className="stat-card">
                <p className="text-xs text-orange-500 uppercase">{label}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {data.opportunities?.length > 0 && (
              <div className="glass-card p-4 md:p-5">
                <h2 className="section-title mb-3 flex items-center gap-2"><MdTrendingUp className="text-orange-500" /> Demand Opportunities</h2>
            ...
            <div className="glass-card p-4 md:p-5">
              ...
              {data.growing_products?.length > 0 && (
                <div className="mb-3">
                  <p className="text-xs font-semibold text-orange-600 mb-2 flex items-center gap-1"><MdTrendingUp /> High Growth</p>
              ...
              {!data.growing_products?.length && !data.declining_products?.length && (
                <p className="text-sm text-orange-400 text-center py-4">Complete more forecasts to see product trends.</p>
              )}
            </div>
          </div>
        </>
