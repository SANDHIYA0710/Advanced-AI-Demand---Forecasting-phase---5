    ...
    <div className="space-y-4 md:space-y-6 max-w-2xl">
      ...
      <div className="glass-card p-4 md:p-5 flex items-center gap-3 md:gap-4">
        <div className="w-12 h-12 md:w-14 md:h-14 bg-primary-200 dark:bg-primary-800 rounded-2xl flex items-center justify-center flex-shrink-0">
          <MdPerson className="text-orange-700 dark:text-orange-300 text-2xl md:text-3xl" />
        </div>
        ...
        <div className="glass-card p-4 md:p-6 animate-fade-in">
          ...
          <form onSubmit={handleSaveInfo} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-orange-400 mt-1">Username cannot be changed</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button onClick={() => theme === "dark" && toggleTheme()}
                className={`p-4 rounded-xl border-2 transition-all duration-200 text-left
                  ${theme === "light" ? "border-orange-500 bg-primary-50" : "border-orange-200 dark:border-orange-800 hover:border-orange-400"}`}>
                ...
                <p className="text-xs text-orange-400 mt-0.5">Clean bright interface</p>
              ...
              <button onClick={() => theme === "light" && toggleTheme()}
                className={`p-4 rounded-xl border-2 transition-all duration-200 text-left
                  ${theme === "dark" ? "border-orange-500 bg-primary-900/50" : "border-orange-200 dark:border-orange-800 hover:border-orange-400"}`}>
                <div className="w-10 h-10 bg-primary-950 rounded-lg border border-orange-800 flex items-center justify-center mb-3">
                  <MdDarkMode className="text-orange-400 text-xl" />
                </div>
                <p className="font-semibold text-sm" style={{ color: "var(--text)" }}>Dark Mode</p>
                <p className="text-xs text-orange-400 mt-0.5">Easy on the eyes</p>
